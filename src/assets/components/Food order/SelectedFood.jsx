...
//    const userData=useLoaderData();
    ...
    const cardAmount = location.state.cardAmount;
    const cardHolder=location.state.cardholder;
        ...
        <div className="container mx-auto mt-10">
            ...
            <div className="flex justify-between items-center mt-8">
                ...
                <div>
                    ...
                    <button onClick={payByStudentCard} className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 ml-4">
                        Pay by Student Card
                    </button>
                </div>
            </div>
