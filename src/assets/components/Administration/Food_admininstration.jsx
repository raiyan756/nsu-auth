    ...
    return (
        ...
        <form onSubmit={handleadmin} className="max-w-sm mx-auto">
          ...
          <div className="mb-4">
            ...
            <input type="number" name="prize" id="phone"  autocomplete="off" className="mt-1 p-2 w-full rounded border border-blue-500 focus:border-blue-700 focus:ring focus:ring-blue-200" />
          </div>
          
          
          
           <button type="submit" className="w-full bg-blue-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:bg-blue-600">Add Food</button>
...
export default Food_admininstration;